...
def get_jobs(user_params: JobsParams):
    ...
    def stop_extraction():
        extraction_completed.wait(70)  # Wait for up to 90 seconds for extraction to complete
        timeout_event.set()
...
if __name__ == "__main__":
  ...
  try:
    start_time = time.time()
    url_list = [
        'https://99jobs.com/opportunities/filtered_search?utf8=%E2%9C%93&utm_source=tagportal&utm_medium=busca&utm_campaign=home&utm_id=001&search%5Bterm%5D=software%20engineer',
    ...
    def stop_extraction():
        extraction_completed.wait(130)  # Wait for up to 90 seconds for extraction to complete
        timeout_event.set()
